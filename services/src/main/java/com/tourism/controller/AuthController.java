...
@Tag(name = "Auth")
@Slf4j
@RequestMapping(path = EndpointConstants.ROOT_PATH + EndpointConstants.AUTH_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
@Validated
...
public class AuthController {
   ...
   @Operation(summary = "EndPoint that performs a user login and returns the authentication token, id token and refresh token.", operationId =
         "login")
