...
class PricingServiceTests {
   ...
   @BeforeEach
   void setUp() {
      lodging = new Lodging("Hotel Test", "Un hotel de pruebas", "Calle falsa 123", "+59899123456", 5, 25.0, 4, new TouristicPlace(),
   ...
   void testCalculateBookingPriceStandardWeekdaysOnly() {
      ...
      List<LocalDate> dates = Arrays.asList(LocalDate.of(2024, 7, 1), // Monday
   ...
   void testCalculateBookingStandardPriceWeekendIncluded() {
      ...
      List<LocalDate> dates = Arrays.asList(LocalDate.of(2024, 7, 5), // Friday
   ...
   void testCalculateBookingStandardPriceMixedDays() {
      ...
      List<LocalDate> dates = Arrays.asList(LocalDate.of(2024, 7, 4), // Thursday
   ...
   private static Stream<Arguments> providePremiumTestCases() {
      return Stream.of(Arguments.of("Weekdays Only", Arrays.asList(LocalDate.of(2024, 7, 1), // Monday
            LocalDate.of(2024, 7, 2), // Tuesday
            LocalDate.of(2024, 7, 3)  // Wednesday
      ), 825.0), Arguments.of("Weekend Included", Arrays.asList(LocalDate.of(2024, 7, 5), // Friday
            LocalDate.of(2024, 7, 6), // Saturday
            LocalDate.of(2024, 7, 7)  // Sunday
      ), 825.0), Arguments.of("Mixed Days", Arrays.asList(LocalDate.of(2024, 7, 4), // Thursday
            LocalDate.of(2024, 7, 5), // Friday
            LocalDate.of(2024, 7, 6)  // Saturday
      ), 825.0));
   }
